...
class Globalvireables {
  ...
  static String timeAPI =
      "http://" + Globalvireables.connectIP + "/api/Login/GetDateTime";
  static String loginAPI =
      "http://" + Globalvireables.connectIP + "/api/Login/PostUserDefinition";
  static String GetUser =
      "http://" + Globalvireables.connectIP + "/api/Login/GetUserDefinition";
  static String ItemsAPI =
      "http://" + Globalvireables.connectIP + "/api/Items/GetinvfByManId/";
  static String CustomersAPI =
      "http://" + Globalvireables.connectIP + "/api/Customers/GetcusfByManId";
  static String VisitsPost =
      "http://" + Globalvireables.connectIP + "/api/Visits/PostManVisit";
  static String UpdateManStatus =
      "http://" + Globalvireables.connectIP + "/api/SalesMan/UpdateManStatus";
  static String GetManStatus =
      "http://" + Globalvireables.connectIP + "/api/SalesMan/GetManStatus";
  static String GetAllSalesManAtt =
      "http://" + Globalvireables.connectIP + "/api/SalesMan/GetAllSalesMan";
  static String VisitsListAPI =
      "http://" + Globalvireables.connectIP + "/api/Visits/GetManVisitsList/";
  static String DropDownlist =
      "http://" + Globalvireables.connectIP + "/api/Visits/GetfollowerMan/";
  static String ListVisitDetail =
      "http://" + Globalvireables.connectIP + "/api/Visits/GetVisitDetails/";
  static String VisitsImageAPI = "http://" +
      Globalvireables.connectIP +
      "/api/Visits/GetVisitsImagesList/";
  static String VisitsitemsAPI = "http://" +
      Globalvireables.connectIP +
      "/api/Visits/GetCustomerStockList/";
  static String Getusertype =
      "http://" + Globalvireables.connectIP + "/api/Login/Getusertype/";
  static String UpdateLoc =
      "http://" + Globalvireables.connectIP + "/api/Customers/UpdateLoc";
  ...
  static String connectIP = "10.0.1.170:3753";
  // static String connectIP="192.168.20.106:1221"; //! main
